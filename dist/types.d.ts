...
export type UpdatePointInput = {
    RangeKeyValue: AttributeValue;
    GeoPoint: GeoPoint;
    UpdateItemCommandInput: Omit<Omit<UpdateItemCommandInput, 'TableName'>, 'Key'>;
};
